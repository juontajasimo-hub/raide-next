...
const steps = [
  ...
  },
  {
    num: "03",
    title: "LEARN & SHARE",
    desc: "Results, data, and insights flow across the ecosystem. Feeding R&D pipelines, joint projects, new ventures.",
  },
  {
    num: "04",
    title: "DEPLOY",
...
export default function PipelineSection() {
  ...
  const ref3 = useScrollReveal(3 * 100)
  const stepRefs = [ref0, ref1, ref2, ref3]

  return (
    <section id="pipeline" className="py-32 md:py-40">
